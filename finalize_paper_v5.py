...
def finalize_paper():
    ...
    try:
        ...
        # 3. Images
        # Find V. 실험 결과 to insert AFTER it (or before Discussion)
        ...
        elif find.Execute(FindText="V. 실험 결과"):
             # After Results? No, let's just append at end if VI not found.
             pass
             
        # Create a range to insert
        ...
        for i in range(2, cnt + 1):
            try:
                ...
                # Add text for user to manually adjust
                rng_insert.InsertParagraphAfter()
                
                # Update rng_insert to end
